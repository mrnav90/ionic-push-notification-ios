...
app.controller('AppCtrl', function($scope, $cordovaPush, $cordovaDialogs, $cordovaMedia, $cordovaToast, ionPlatform, $http) {
    ...
    // After build please replace Bundle identifier from Xcode
    // Use ID demo: com.nav.ionicpushnotification
    ...
    $scope.register = function () {
        ...
        if (ionic.Platform.isAndroid()) {
            config = {
                "senderID": "https://console.developers.google.com/project/ionic-push-notification-1050" // REPLACE THIS WITH YOURS FROM GCM CONSOLE - also in the project URL like: https://console.developers.google.com/project/434205989073
            };
        }
